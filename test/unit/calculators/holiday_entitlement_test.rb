      ...
      context "starting part way through a leave year" do
        ...
        context "for department test data" do
          ...
          should "dept test 4" do
            ...
            assert_equal "1.4", calc.formatted_full_time_part_time_weeks
          end
          ...
          should "dept test 6" do
            calc = HolidayEntitlement.new(
              start_date: Date.parse("2020-05-15"),
              leave_year_start_date: Date.parse("2019-10-01"),
            )
      ...
      context "leaving part way through a leave year" do
        ...
        context "for department test data" do
          ...
          should "dept test 9" do
            ...
            assert_equal "2.8", calc.formatted_full_time_part_time_weeks
          end
    ...
    context "calculate entitlement on annualised hours" do
      ...
      context "starting part way through a leave year" do
        ...
        context "for department test data" do
          ...
          # /annualised-hours/starting/2020-03-09/2019-12-01
          should "dept test 3" do
            calc = HolidayEntitlement.new(
              start_date: Date.parse("2020-03-09"),
              leave_year_start_date: Date.parse("2019-12-01"),
            )

            assert_equal "1.4", calc.formatted_full_time_part_time_weeks
          end
          # /annualised-hours/starting/2019-03-01/2019-12-01
          should "dept test 4" do
            calc = HolidayEntitlement.new(
      ...
      context "starting and leaving part way through a leave year" do
        ...
        context "for department test data" do
          # /annualised-hours/starting-and-leaving/2019-12-01/2019-03-27
          should "dept test 16" do
            calc = HolidayEntitlement.new(
          ...
          # /annualised-hours/starting-and-leaving/2018-12-10/2019-04-15
          should "dept test 17" do
            calc = HolidayEntitlement.new(
              start_date: Date.parse("2018-12-10"),
              leaving_date: Date.parse("2019-04-15"),
            )

            assert_equal "2.4", calc.formatted_full_time_part_time_weeks
          end
          ...
          # /annualised-hours/starting-and-leaving/2019-10-02/2019-12-20
          should "dept test 19" do
            calc = HolidayEntitlement.new(
              start_date: Date.parse("2019-10-02"),
          ...
          should "dept test 20" do
            ...
            assert_equal "4.6", calc.formatted_full_time_part_time_weeks
          end
