  ...
  class CoronavirusFindSupportFlow < Flow
    def define
      ...
      checkbox_question :need_help_with? do
        ...
        next_node do
          if calculator.needs_help_with?("feeling_unsafe")
            question :feel_safe?
          elsif calculator.needs_help_with?("paying_bills")
            question :afford_rent_mortgage_bills?
          elsif calculator.needs_help_with?("getting_food")
            question :afford_food?
          elsif calculator.needs_help_with?("being_unemployed")
            question :self_employed?
          elsif calculator.needs_help_with?("going_to_work")
            question :worried_about_work?
          elsif calculator.needs_help_with?("somewhere_to_live")
            question :have_somewhere_to_live?
          elsif calculator.needs_help_with?("mental_health")
      ...
      multiple_choice :feel_safe? do
        ...
        next_node do
          if calculator.needs_help_with?("paying_bills")
            question :afford_rent_mortgage_bills?
          elsif calculator.needs_help_with?("getting_food")
            question :afford_food?
          elsif calculator.needs_help_with?("being_unemployed")
      ...
      multiple_choice :afford_rent_mortgage_bills? do
        ...
        next_node do
          if calculator.needs_help_with?("getting_food")
            question :afford_food?
          elsif calculator.needs_help_with?("being_unemployed")
            question :self_employed?
          elsif calculator.needs_help_with?("going_to_work")
      ...
      multiple_choice :get_food? do
        ...
        next_node do
          if calculator.get_food == "yes"
            if calculator.needs_help_with?("being_unemployed")
              question :self_employed?
            elsif calculator.needs_help_with?("going_to_work")
              question :worried_about_work?
            elsif calculator.needs_help_with?("somewhere_to_live")
      ...
      multiple_choice :are_you_off_work_ill? do
        ...
        next_node do
          if calculator.needs_help_with?("going_to_work")
            question :worried_about_work?
          elsif calculator.needs_help_with?("somewhere_to_live")
            question :have_somewhere_to_live?
          elsif calculator.needs_help_with?("mental_health")
      ...
      multiple_choice :worried_about_work? do
        ...
        next_node do
          if calculator.needs_help_with?("somewhere_to_live")
            question :have_somewhere_to_live?
          elsif calculator.needs_help_with?("mental_health")
            question :mental_health_worries?
          else
      ...
      multiple_choice :have_you_been_evicted? do
        ...
        next_node do
          if calculator.needs_help_with?("mental_health")
            question :mental_health_worries?
          else
            question :nation?
          end
