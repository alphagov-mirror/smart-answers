...
RSpec.feature "CalculateYourHolidayEntitlementFlow", type: :feature do
  ...
  context "days-worked-per-week" do
    ...
    scenario "starting" do
      ...
      what_is_your_starting_date(14, 3, Time.zone.now.year)
      when_does_your_leave_year_start(2, 3, Time.zone.now.year)
      how_many_days_per_week 5
      expect(page).to have_selector("p", text: statutory_entitlement(28))
    end
    ...
    scenario "leaving" do
      ...
      what_is_your_leaving_date(14, 7, Time.zone.now.year)
      when_does_your_leave_year_start(1, 1, Time.zone.now.year)
      how_many_days_per_week 5
    ...
    scenario "starting-and-leaving" do
      ...
      what_is_your_starting_date(14, 7, Time.zone.now.year)
      what_is_your_leaving_date(14, 10, Time.zone.now.year)
      how_many_days_per_week 5
  ...
  context "hours-worked-per-week" do
    ...
    scenario "starting" do
      calculation_period calculation_periods[:starting]
      what_is_your_starting_date(1, 6, Time.zone.now.year)
      when_does_your_leave_year_start(1, 1, Time.zone.now.year)
      how_many_hours_per_week 40
      how_many_days_per_week_for_hours 5
    ...
    scenario "leaving" do
      calculation_period calculation_periods[:leaving]
      what_is_your_leaving_date(1, 6, Time.zone.now.year)
      when_does_your_leave_year_start(1, 1, Time.zone.now.year)
      how_many_hours_per_week 40
      how_many_days_per_week_for_hours 5
    ...
    scenario "starting-and-leaving" do
      calculation_period calculation_periods[:starting_and_leaving]
      what_is_your_starting_date(20, 1, Time.zone.now.year)
      what_is_your_leaving_date(18, 7, Time.zone.now.year)
      how_many_hours_per_week 40
      how_many_days_per_week_for_hours 5
  ...
  context "compressed-hours" do
    ...
    scenario "leaving - non-leap year" do
      calculation_period calculation_periods[:leaving]
      what_is_your_leaving_date(1, 6, Time.zone.now.year - 1)
      when_does_your_leave_year_start(1, 1, Time.zone.now.year - 1)
      how_many_hours_per_week 40
      how_many_days_per_week_for_hours 5
    ...
    scenario "starting-and-leaving - non-leap year" do
      calculation_period calculation_periods[:starting_and_leaving]
      what_is_your_starting_date(20, 1, Time.zone.now.year - 1)
      what_is_your_leaving_date(18, 7, Time.zone.now.year - 1)
      how_many_hours_per_week 40
      how_many_days_per_week_for_hours 5
